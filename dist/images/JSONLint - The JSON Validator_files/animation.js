...
function build_timeline_main() {	
	...
	function bg1In() {
		var bg1TL = new TimelineMax();
			bg1TL.timeScale(2)
				...
				.fromTo(["#img_towel1", "#img_towel1_front"], 3.2,{x:-600, ease:Power0.easeNone},{x:600, ease:Power0.easeNone}, "start")
				.to("#img_bag1", .001, {autoAlpha:0}, "start+=1.5")
				.from(["#img_bag2", "#img_bag2_front"], .001, {autoAlpha:0}, "start+=1.5")
				.to("#img_bag1", .001, {autoAlpha:1}, "start+=1.7")
				.to(["#img_bag2", "#img_bag2_front"], .001, {autoAlpha:0}, "start+=1.71")
		
				.add("towel2", "+=.5")
				 
				.fromTo(["#img_towel2", "#img_towel2_front"], 3.2,{x:-600, ease:Power0.easeNone},{x:600, ease:Power0.easeNone}, "towel2")
				
				.to("#img_drink", .001, {autoAlpha:0}, "towel2+=1.51")
				.from(["#img_spill"], .001, {autoAlpha:0}, "towel2+=1.51")
			
				.add("towel3", "+=.5")
				 
				.fromTo(["#img_towel3"], 3.2,{x:-600, ease:Power0.easeNone},{x:600, ease:Power0.easeNone}, "towel3")
	...
	var mainTL = new TimelineMax();
		...
		.set(["#img_beach"], {scale:.9, x:0, transformOrigin:"0% 0%"}, "fr0")
		.set(["#main_img"], {scale:.9, x:200, y:-40, transformOrigin:"0% 0%"}, "fr0")
		.add("fr1", "+=0")
